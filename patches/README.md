...
Generated from `patches/h3-0.0.8.patch` by `scripts/materialize-vendor.sh`,
applied to the `hyperium/h3` checkout at the revision pinned in
`Cargo.toml`.
...
## h3-datagram 0.0.2 (generated)

Generated from `patches/h3-datagram-0.0.2.patch` by
`scripts/materialize-vendor.sh`, applied to the `hyperium/h3` checkout at
the revision pinned in `Cargo.toml`. The patch only removes a commented-out
dependency line.

## h3-webtransport 0.1.2 (generated)

Generated from `patches/h3-webtransport-0.1.2.patch` by
`scripts/materialize-vendor.sh`, applied to the `hyperium/h3` checkout at
...
## quinn 0.11.11 and quinn-proto 0.11.16 (generated)

Generated from `patches/quinn-0.11.11.patch` and
`patches/quinn-proto-0.11.16.patch` by `scripts/materialize-vendor.sh`.
...
## rustls 0.23.43 (generated)

Generated from `patches/rustls-0.23.43.patch` by
