...
pub use proto::{
    ...
    ConnectError, ConnectionClose, ConnectionError, ConnectionId, ConnectionIdEvent,
    ConnectionIdGenerator, ConnectionStats, Dir, EcnCodepoint, EndpointConfig, FrameStats, FrameType,
    IdleTimeout,
